...
# pdf_path: 템플릿.pdf가 저장되어 있는 경로 , person_name : 사용자 이름 이니셜을 추천합니다. ex : jh, kh 등 입력하실때 ''를 사용해서 str 형식으로 입력하시기 바랍니다.
# 코드를 보시면 아시겠지만, person_name에 입력하신 값으로 person_name_fonts라는 폴더를 생성합니다.
# ----------------------------------------------------------------------------------------------------------------------------------------------------------    
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------    
    ...
    for page in pdf: # p
        ...
        else: # pdf 1페이지의 경우  # 위에 입력과 거의 동일함
