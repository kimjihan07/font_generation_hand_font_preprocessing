...
def from_PDF_crop_Handfonts(pdf_path, person_name): 
# ----------------------------------------------------------------------------------------------------------------------------------------------------------    
# 해당 레포지토리를 그대로 git hub에서 clone할 경우 바로 실행될 것임.    
#     pdf_path = convert_from_path('/home/piai/Ai/project/makeme/210_template_HW.pdf') # pdf파일을 이미지로 변환 convert_form_path 메소드 검색해 볼것
